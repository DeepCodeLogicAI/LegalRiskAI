...
public class AiDto {
    ...
    public static class AnalyzeResponse {
        ...
        public void setOverall_risk_level(String overall_risk_level) {
            this.overall_risk_level = overall_risk_level;
        }
        ...
        public void setSimilar_cases(List<SimilarCase> similar_cases) {
    ...
    public static class SimilarCase {
        ...
        private String full_text;   // 판례 전문 (case_text)
        ...
        public void setXai_reason(String xai_reason) {
            this.xai_reason = xai_reason;
        }
